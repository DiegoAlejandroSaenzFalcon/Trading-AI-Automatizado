...
def get(start_idx, max_lines=250):
    depth = 0
    out = []
...
for fn in ["bool SpreadOK(", "bool RegimeOK(", "bool BarsSinceEntryOK(", "double GetTradeLotSize(", "double GetMinStopDistPrice()", "bool NearActiveZone(", "void UpdateAdaptiveNoise(", "void CheckVolatilityTimeStop(", "bool TryPartialTP("]:
    i = find(fn)
