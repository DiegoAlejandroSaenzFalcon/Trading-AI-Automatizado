...
input int    Inp_ATR_Period = 124;//14
input double Inp_TP_Mult    = 18.3;//3.0
input double Inp_SL_Mult    = 1.2;//1.0
input int    Inp_SessStart  = 1;
input int    Inp_SessEnd    = 1;

input group "━━━━━ AUTO-TRADING ━━━━━"
input bool   Inp_AutoTrade  = true;
input double Inp_LotSize    = 0.01;
input ulong  Inp_Magic      = 20260304;
input uint   Inp_Slippage   = 3440;//800
