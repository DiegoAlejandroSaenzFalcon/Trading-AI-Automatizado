...
input double Inp_CTMaxSpreadPoints   = 2000; // BTC Spread Tolerancia
input double Inp_CTMaxSpreadOff      = 3000; // BTC Spread Tolerancia
...
input int    Inp_MaxSpread           = 2500; // Escalado para el spread de BTCUSD
