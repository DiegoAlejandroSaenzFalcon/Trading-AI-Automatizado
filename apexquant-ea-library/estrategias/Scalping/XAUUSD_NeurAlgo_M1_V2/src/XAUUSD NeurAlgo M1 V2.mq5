...
input double Inp_CTMaxSpreadOff       = 20.0;
...
{
   switch(sess) {
      case SESSION_ASIAN:   return 24;
      case SESSION_LONDON:  return 21;
      case SESSION_OVERLAP: return 20;
      case SESSION_NY:      return 19;
      default:              return 25;
   }
}
...
void UpdateDash()
{
   ...
   AQLbl("AQ90_SENS3","AllOK:"+(m_sensors.allOK?"SI":"NO: "+m_sensors.blockReason),x,y,(m_sensors.allOK?cGreen:cOra),9);y+=lh;
