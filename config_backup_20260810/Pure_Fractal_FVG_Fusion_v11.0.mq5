...
//===================================================================
string GV_DayStart(){ return("PFVG11_"+_Symbol+"_"+IntegerToString(g_magic)+"_dayStart"); }
string GV_DayPL()   { return("PFVG11_"+_Symbol+"_"+IntegerToString(g_magic)+"_dayPL"); }
string GV_Cooldown(){ return("PFVG11_"+_Symbol+"_"+IntegerToString(g_magic)+"_cooldown"); }
