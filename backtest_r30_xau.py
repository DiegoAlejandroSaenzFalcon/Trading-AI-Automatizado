...
INP = dict(
    ...
    LotMode=1, FixedLotSize=0.01, RiskPerTradeUSD=6.0, MaxLotSize=0.40,
...
AVG_SPREAD_EST = 0.26  # USD, spread tipico BTCUSDm demo
...
def main():
    ...
    print()
    print("=== ESTUDIO: sesion OFF â€” PnL por hora de entrada (hora servidor) ===")
