...
def run_gold(frm, to, risk_usd, max_lot, h1_, h2_, macro_h4=False):
    ...
    macro = h1 if not macro_h4 else h4
...
print("=== ORO FVG OOS mayo-ago: ventanas top (macro H1) ===")
for h1_, h2_ in [(14,16),(14,17),(12,16),(13,16),(15,18)]:
    t = run_gold(frm2, to2, 8, 0.5, h1_, h2_)
    stats(t, f"OOS ventana {h1_:02d}-{h2_:02d}")
print("=== ORO FVG OOS 14-16: riesgo y cap ===")
for r,c in [(6,0.5),(8,0.5),(10,0.5),(8,0.8),(12,1.0)]:
    t = run_gold(frm2, to2, r, c, 14, 16)
    stats(t, f"OOS 14-16 riesgo ${r} cap {c}")
mt5.shutdown()
