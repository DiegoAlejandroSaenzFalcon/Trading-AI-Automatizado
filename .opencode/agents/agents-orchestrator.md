...
### ðŸ“‹ Product & Project Management Agents
...
### ðŸ› ï¸ Support & Operations Agents
...
```
Please spawn an agents-orchestrator to execute complete development pipeline for project-specs/[project]-setup.md. Run autonomous workflow: project-manager-senior â†’ ArchitectUX â†’ [Developer â†” EvidenceQA task-by-task loop] â†’ testing-reality-checker. Each task must pass QA before advancing.
```
