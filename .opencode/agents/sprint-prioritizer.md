...
- **Delivery Predictability**: Â±10% variance from estimated timelines with trend improvement
...
- **Score**: (Reach Ã— Impact Ã— Confidence) Ã· Effort with sensitivity analysis
...
- **Risk Scoring**: Probability Ã— Impact matrix with regular reassessment
