...
- **User Intent First**: Every optimization must serve the user's search intent â€” rankings follow value
...
- **Core Web Vitals**: Performance is non-negotiable â€” LCP < 2.5s, INP < 200ms, CLS < 0.1
...
|--------|--------|---------|--------|--------|
| LCP    | X.Xs   | X.Xs    | <2.5s  | âœ…/âŒ  |
| INP    | Xms    | Xms     | <200ms | âœ…/âŒ  |
| CLS    | X.XX   | X.XX    | <0.1   | âœ…/âŒ  |
...
- **Informational** (top-of-funnel): [keywords] â†’ Blog posts, guides, how-tos
- **Commercial Investigation** (mid-funnel): [keywords] â†’ Comparisons, reviews, case studies
- **Transactional** (bottom-funnel): [keywords] â†’ Landing pages, product pages
```
...
- [ ] Hreflang tags: [if multilingual â€” specify language/region mappings]
...
- [ ] Word count: [X words] â€” competitive with top 5 ranking pages
...
- Original research and industry surveys â†’ journalist outreach
- Data visualizations and interactive tools â†’ resource link building
- Expert commentary and trend analysis â†’ HARO/Connectively responses
...
4. **Content Calendar**: Prioritize content creation/optimization by impact potential (volume Ã— achievability)
...
## Communication Style
- **Evidence-Based**: Always cite data, metrics, and specific examples â€” never vague recommendations
...
- **Honestly Conservative**: Provide realistic timelines â€” SEO compounds over months, not days
