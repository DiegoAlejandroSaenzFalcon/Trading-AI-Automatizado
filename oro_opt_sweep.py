import importlib.util, csv, sys, os
...
out = r"C:\Users\H2R\Documents\Default Project\oro_opt_sweep.csv"
variants = [
    ("baseline", {}),
    ("cooldown15", {"CooldownMinutes": 15}),
    ("cooldown30", {"CooldownMinutes": 30}),
    ("cooldown60", {"CooldownMinutes": 60}),
    ("minbars2", {"MinBarsBetweenEntries": 2}),
    ("minbars3", {"MinBarsBetweenEntries": 3}),
    ("macro_off", {"MacroBiasEnable": False}),
    ("zoneProx_off", {"RequireZoneProximity": False}),
